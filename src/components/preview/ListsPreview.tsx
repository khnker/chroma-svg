...
export function ListsPreview({ primary, secondary }: ComponentPreviewProps) {
  return (
    <div className="space-y-4 max-w-sm">
      <div>
        <p className="text-xs text-neutral-400 mb-1">Unordered List</p>
      ...
      <div>
        <p className="text-xs text-neutral-400 mb-1">Description List</p>
        <dl className="text-sm space-y-2">
          <div className="flex gap-4">
            <dt className="w-20 font-medium" style={{ color: secondary }}>Email</dt>
            <dd className="text-neutral-700">user@example.com</dd>
          </div>
          <div className="flex gap-4">
            <dt className="w-20 font-medium" style={{ color: secondary }}>Role</dt>
            <dd className="text-neutral-700">Administrator</dd>
          </div>
          <div className="flex gap-4">
