  ...
  return (
    <div className="space-y-1.5">
      <div className="flex items-center justify-between">
        <span className="text-xs font-medium text-gray-500">Homogenize</span>
      ...
      <div className="flex justify-between text-[10px] text-gray-400">
        <span className={value < 0.1 ? 'text-gray-600 font-medium' : ''}>Original</span>
        <span className={value > 0.9 ? 'text-gray-600 font-medium' : ''}>Centered</span>
      </div>
    </div>
  )
}
